...
CREATE OR REPLACE TRIGGER tr_rhstu_bairro BEFORE
...
CREATE OR REPLACE TRIGGER tr_rhstu_cidade BEFORE
...
CREATE SEQUENCE sq_rhstu_cons_form_pagto START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu__cons_form_pagto BEFORE
...
CREATE SEQUENCE sq_rhstu_pac_email START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu_pac_email BEFORE
    INSERT ON t_rhstu_email_paciente
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER tr_rhstu_end_paciente BEFORE
...
CREATE OR REPLACE TRIGGER tr_rhstu_estado BEFORE
...
CREATE SEQUENCE sq_rhstu_forma_pagto START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu_forma_pagto BEFORE
    INSERT ON t_rhstu_forma_pagamento
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER tr_rhstu_logradouro BEFORE
...
CREATE OR REPLACE TRIGGER tr_rhstu_medicamento BEFORE
...
CREATE OR REPLACE TRIGGER tr_rhstu_medico BEFORE
...
CREATE OR REPLACE TRIGGER rt_rhstu_paciente BEFORE
...
CREATE SEQUENCE sq_rhstu_paciente_ps START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu_paciente_ps BEFORE
...
CREATE SEQUENCE sq_rhstu_plano_saude START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu_plano_saude BEFORE
    INSERT ON t_rhstu_plano_saude
    FOR EACH ROW
...
CREATE SEQUENCE sq_rhstu_presc_medica START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu_presc_medica BEFORE
...
CREATE OR REPLACE TRIGGER tr_rhstu_tipo_contato BEFORE
...
CREATE SEQUENCE sq_rhstu_unid_hosp START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tr_rhstu_unid_hosp BEFORE
